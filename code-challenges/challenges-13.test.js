...
const longestString = (arr) => {
  let longest = arr.reduce((a, b) => a.length < b.length ? b : a ,"");
...
const standardizePhoneNumbers = (arr) => {
  let noSpace = arr.map((num)=>num.replace(/[^0-9]/g,''));
  return noSpace;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5 
