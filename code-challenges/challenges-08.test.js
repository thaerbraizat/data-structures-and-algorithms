...
Write a function named sortByChildren that sorts the characters below by the number of c
hildren in each house (fewest to most). 
...
Write a function named isCapitalized that takes in a string.
 This function should use a regular expression pattern to match all 
 words that begin with a capital letter. It should only match words, not punctuation.

Return an array containing all the matches.
------------------------------------------------------------------------------------------------ */
const isCapitalized = (str) => {
  let array = /[A-Z][a-zA-Z]*/g;
  if (str.match(array)){
    return str.match(array);
  }if (str.match(array)==null){
    return [];
  }
...
const citiesAtoJ = (arr) => {
  let array = /[A-J][a-zA-Z]*/g;

  let array1= arr.filter((str)=>{
     if(str.match(array) == str){
 return str;
     }
